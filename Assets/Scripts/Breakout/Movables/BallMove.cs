...
public class BallMove : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Starto && !Demo)
        {
            ...
            if ((pInput.Movement.Play.IsPressed() || Input.GetMouseButtonUp(0)) && test == 1)
            {
                ...
                Vector3 fforce = new Vector3(0f, 1f, 0f);
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject == Paddle)
        {
            if (AC != null)
            {
                ...
                ballPitch = 0;
                AC.PlayPitch(1, AC.paddleSounds, Random.Range(0, AC.paddleSounds.Count), 1);
            }
        ...
        else if (collision.gameObject.CompareTag("Block"))
        {
            if (AC != null)
            {
                ...
                AC.PlayPitch(ballPitch, AC.blockSounds, Random.Range(0, AC.blockSounds.Count), 1);
            }
        ...
        else
        {
            if (AC != null)
            {
                ...
                AC.PlayPitch(1, AC.wallSounds, Random.Range(0, AC.wallSounds.Count), 1);
            }
    ...
    {
        StartSpeedEffect(0.5f, 20f); // 0.5x speed for 5 seconds
    }
